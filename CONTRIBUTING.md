# Contributing to xfiles
First off, thank you for considering contributing to xfiles. 
It's people like you that make xfiles great!
...
```bash
git clone https://github.com/cryptopatrick/xfiles.git
cd xfiles
```
...
To run xfiles, piping the output into [bunyan](https://github.com/LukeMathWalker/bunyan) to format outputted the structured logs:
...
2. [Submit a pull request](https://github.com/cryptopatrick/xfiles/pulls) to the original repository.
...
## Reporting Issues
Please use the [issue tracker](https://github.com/cryptopatrick/xfiles/issues) to report any bugs or request new features.
...
Thank you for contributing to xfiles!
